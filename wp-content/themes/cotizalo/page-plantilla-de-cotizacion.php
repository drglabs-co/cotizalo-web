...
<head>
    ...
    <meta name="keywords" content="plantilla de cotizacion, formato de cotizacion, plantilla cotizacion gratis, modelo de cotizacion, formato presupuesto, ejemplo de cotizacion, como hacer una cotizacion">
    ...
    <meta property="og:description" content="Plantilla de cotización profesional gratis. Aprende qué debe incluir y cómo generarla en segundos con Cotízalo.">
    ...
    <meta name="twitter:description" content="Plantilla de cotización gratis. Aprende qué incluir y genera la tuya en segundos con Cotízalo.">
    ...
    <style>
        .lp-hero { padding-top: calc(var(--nav-height) + 5rem); padding-bottom: 5rem; background: linear-gradient(135deg, var(--primary) 0%, #1a4d38 60%, var(--bg-surface) 100%); text-align: center; }
        ...
        .template-section { background: #fff; padding: 5rem 0; }
        ...
        /* Template mockup */
        .template-mockup { max-width: 720px; margin: 0 auto; border: 1px solid var(--border-light); border-radius: var(--radius-lg); overflow: hidden; box-shadow: 0 20px 60px rgba(18,58,44,0.15); }
        .tmpl-header { background: var(--primary); padding: 2rem 2.5rem; display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 1rem; }
        .tmpl-header .company-name { font-size: 1.5rem; font-weight: 700; color: #fff; }
        .tmpl-header .doc-title { color: rgba(255,255,255,0.7); font-size: 0.875rem; margin-top: 0.25rem; }
        .tmpl-header .doc-meta { text-align: right; color: rgba(255,255,255,0.85); font-size: 0.9rem; line-height: 1.7; }
        .tmpl-body { background: #fff; padding: 2.5rem; }
        .tmpl-parties { display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem; }
        @media (max-width: 600px) { .tmpl-parties { grid-template-columns: 1fr; } }
        .tmpl-party h4 { font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: var(--text-dark-muted); margin-bottom: 0.5rem; }
        .tmpl-party p { font-size: 0.9rem; color: var(--text-dark); line-height: 1.6; }
        .tmpl-table { width: 100%; border-collapse: collapse; margin-bottom: 1.5rem; }
        .tmpl-table th { background: var(--bg-light-alt); color: var(--text-dark-muted); font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; padding: 0.75rem 1rem; text-align: left; }
        .tmpl-table td { padding: 0.9rem 1rem; border-bottom: 1px solid var(--border-light); font-size: 0.9rem; color: var(--text-dark); }
        .tmpl-table td:last-child, .tmpl-table th:last-child { text-align: right; }
        .tmpl-totals { margin-left: auto; max-width: 280px; }
        .tmpl-totals-row { display: flex; justify-content: space-between; padding: 0.5rem 0; font-size: 0.9rem; color: var(--text-dark-muted); border-bottom: 1px solid var(--border-light); }
        .tmpl-totals-row.total { font-weight: 700; color: var(--text-dark); font-size: 1.05rem; border-bottom: none; padding-top: 0.75rem; }
        .tmpl-footer-note { margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid var(--border-light); font-size: 0.85rem; color: var(--text-dark-muted); line-height: 1.6; }

        /* Checklist section */
        .checklist-section { background: var(--bg-light-alt); padding: 5rem 0; }
        .checklist-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.25rem; max-width: 760px; margin: 0 auto; }
        @media (max-width: 640px) { .checklist-grid { grid-template-columns: 1fr; } }
        .checklist-item { display: flex; align-items: flex-start; gap: 1rem; background: #fff; border: 1px solid var(--border-light); border-radius: var(--radius-md); padding: 1.25rem; }
        .checklist-check { flex-shrink: 0; width: 28px; height: 28px; background: var(--primary); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 0.8rem; font-weight: 700; }
        .checklist-item h4 { font-size: 0.95rem; font-weight: 600; color: var(--text-dark); margin-bottom: 0.25rem; }
        .checklist-item p { font-size: 0.875rem; color: var(--text-dark-muted); line-height: 1.5; }
        ...
        .lp-cta { background: linear-gradient(135deg, var(--primary) 0%, #1a4d38 100%); padding: 5rem 0; text-align: center; }
...
<body <?php body_class(); ?>>
    ...
    <section class="lp-hero">
        <div class="container relative z-10 animate-on-scroll fade-in-up">
            ...
            <p>Descubre qué elementos debe tener una cotización completa, ve un ejemplo real y genera la tuya automáticamente con Cotízalo. Gratis, sin instalar nada.</p>
            ...
            <p style="margin-top:1.25rem; font-size:0.875rem; color:rgba(255,255,255,0.6);">Sin tarjeta. Sin instalación. Listo en 2 minutos.</p>
        </div>
    </section>
    ...
    <section class="template-section">
        <div class="container animate-on-scroll fade-in-up">
            ...
            <p class="section-subtitle">Cotízalo genera este formato automáticamente con tus datos, tu logo y tus productos.</p>
                ...
                <div class="tmpl-body">
                    <div class="tmpl-parties">
                        <div class="tmpl-party">
                            <h4>Emitida para</h4>
                            <p><strong>Distribuidora García &amp; Asociados</strong><br>Contacto: Lic. María García<br>maria@garcia.com · 55 1234 5678</p>
                        </div>
                        <div class="tmpl-party">
                            <h4>Nota para el cliente</h4>
                            <p>Gracias por su confianza. Quedo a sus órdenes para cualquier aclaración sobre esta propuesta.</p>
                        </div>
                    </div>
                    <table class="tmpl-table">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Diseño de logotipo corporativo<br><small style="color:var(--text-dark-muted);">Incluye 3 propuestas y 2 rondas de revisión</small></td>
                                <td>1</td>
                                <td>$4,500.00</td>
                                <td>$4,500.00</td>
                            </tr>
                    ...
                    <div class="tmpl-footer-note">
                        <strong>Condiciones:</strong> 50% de anticipo para iniciar. Saldo al entregar. Los precios están en MXN e incluyen IVA. Vigencia de esta cotización: 30 días naturales.
                    </div>
                </div>
            </div>

            <div style="text-align:center; margin-top:2.5rem;">
                <p style="color:var(--text-dark-muted); font-size:0.95rem; margin-bottom:1rem;">¿Quieres generar esta cotización con tus propios datos?</p>
                <a href="<?php echo esc_url(get_theme_mod('nav_signup_url', 'https://app.cotizalo.net/signup')); ?>" class="btn btn-primary">Crear mi cotización gratis</a>
            </div>
        </div>
    </section>
    ...
    <section class="checklist-section">
        <div class="container animate-on-scroll fade-in-up">
            ...
            <p class="section-subtitle">Una cotización completa genera más confianza y cierra más ventas. Aquí los elementos que no pueden faltar.</p>
            <div class="checklist-grid">
                <div class="checklist-item"><div class="checklist-check">✓</div><div><h4>Datos del emisor</h4><p>Nombre de la empresa o persona física, RFC, dirección y datos de contacto.</p></div></div>
                <div class="checklist-item"><div class="checklist-check">✓</div><div><h4>Datos del cliente</h4><p>Nombre, empresa, correo y teléfono del contacto que recibirá la propuesta.</p></div></div>
                <div class="checklist-item"><div class="checklist-check">✓</div><div><h4>Número y fecha de cotización</h4><p>Un folio único y la fecha de emisión para identificar y ordenar tus documentos.</p></div></div>
                <div class="checklist-item"><div class="checklist-check">✓</div><div><h4>Descripción detallada</h4><p>Explica claramente cada producto o servicio: qué incluye, qué no incluye y bajo qué condiciones.</p></div></div>
                <div class="checklist-item"><div class="checklist-check">✓</div><div><h4>Precios unitarios y totales</h4><p>Precio por unidad, cantidad, subtotal por línea, subtotal general, IVA y total final.</p></div></div>
                <div class="checklist-item"><div class="checklist-check">✓</div><div><h4>Condiciones de pago</h4><p>Porcentaje de anticipo, forma de pago aceptada (transferencia, efectivo) y plazos.</p></div></div>
                <div class="checklist-item"><div class="checklist-check">✓</div><div><h4>Vigencia de la cotización</h4><p>Fecha hasta la que el precio es válido. Normalmente entre 15 y 30 días naturales.</p></div></div>
                <div class="checklist-item"><div class="checklist-check">✓</div><div><h4>Firma o aprobación</h4><p>Espacio para la firma o aceptación del cliente, ya sea física o digital.</p></div></div>
            </div>
        </div>
    </section>
        ...
        <div class="container animate-on-scroll fade-in-up">
            ...
            <div class="faq-list" style="margin-top:2.5rem;">
                <details class="faq-item">
                    ...
                    <p>Una cotización profesional debe incluir: datos del emisor (empresa, RFC, dirección), datos del cliente, número de cotización y fecha, descripción detallada de productos o servicios, precios unitarios, subtotal, descuentos, IVA, total, condiciones de pago, vigencia y firma del responsable.</p>
                </details>
                <details class="faq-item">
                    <summary>¿Cuál es la diferencia entre una cotización y una factura?</summary>
                    <p>Una cotización es una propuesta de precio que el cliente puede aceptar o rechazar; no tiene validez fiscal. Una factura es un documento fiscal que registra una venta ya realizada. La cotización antecede a la factura y es el primer paso del proceso de venta.</p>
                </details>
                <details class="faq-item">
                    <summary>¿Por cuánto tiempo es válida una cotización?</summary>
                    <p>La vigencia la define el emisor. Lo más común es entre 15 y 30 días naturales. En Cotízalo puedes establecer la fecha de vigencia de cada cotización y el cliente verá si ya venció al abrir el enlace.</p>
                </details>
                <details class="faq-item">
                    <summary>¿Es mejor usar una plantilla de Word/Excel o un software como Cotízalo?</summary>
                    <p>Para negocios que envían más de 3-4 cotizaciones al mes, Cotízalo es mucho más eficiente. Guarda tu catálogo, reutiliza datos de clientes, genera PDFs automáticamente, permite firma digital y da seguimiento, sin copiar y pegar desde una plantilla cada vez.</p>
                </details>
            </div>
        </div>
    </section>
