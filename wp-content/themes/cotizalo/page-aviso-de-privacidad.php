    ...
    <section class="page-hero">
        ...
        <div class="container relative z-10 animate-on-scroll fade-in-up">
            <h1 class="display-title-sm" style="margin-bottom: 1rem;">
                <?php echo esc_html(get_theme_mod('aviso_title', 'Aviso de Privacidad')); ?>
            </h1>
            ...
            <div class="content-box animate-on-scroll fade-in-up delay-100"
                ...
                ?>
                <p>Al contratar y hacer uso del Sistema de Cotizaciones (en adelante, la <strong>"Aplicación"</strong>) proporcionado por <strong>DrG Labs Co.</strong> (en adelante, la <strong>"Sociedad"</strong>), el Cliente acepta estar sujeto a los siguientes términos, condiciones de uso y aviso de privacidad.</p>
                ...
                <h2>4. Confidencialidad y Tratamiento de Datos Personales (Aviso de Privacidad)</h2>
