...
<body <?php body_class(); ?>>
    ...
    <header id="navbar">
        <div class="container nav-container">
            ...
            <ul class="nav-links">
                <li><a href="<?php echo esc_url(home_url('/que-es-cotizalo/')); ?>"
                        class="nav-item nav-item--active">¿Qué es Cotízalo?</a></li>
    ...
    <section style="background:#fff; padding:4rem 0 5rem;">
        <div class="container animate-on-scroll fade-in-up">
            <p class="section-eyebrow"
                style="text-align:center; font-size:0.8rem; font-weight:700; letter-spacing:0.12em; text-transform:uppercase; color:var(--primary); margin-bottom:0.75rem;">
                La plataforma</p>
            <h2
                style="text-align:center; font-size:clamp(1.75rem,3vw,2.5rem); font-weight:700; color:var(--text-dark); margin-bottom:0.75rem; letter-spacing:-0.02em;">
                Así se ve Cotízalo por dentro</h2>
            <p
                style="text-align:center; color:var(--text-dark-muted); font-size:1.05rem; max-width:560px; margin:0 auto 2.5rem;">
                Una interfaz limpia y profesional para gestionar todas tus cotizaciones desde un solo lugar.</p>
            <div
                style="max-width:900px; margin:0 auto; border-radius:14px; overflow:hidden; box-shadow:0 30px 80px rgba(0,0,0,0.12), 0 2px 8px rgba(0,0,0,0.06); border:1px solid rgba(0,0,0,0.07);">
                <!-- Chrome bar -->
                <div
                    style="background:#e8eaed; padding:0.55rem 1rem; display:flex; align-items:center; gap:0.75rem; border-bottom:1px solid rgba(0,0,0,0.08);">
                    <div style="display:flex; gap:6px;">
                        <span
                            style="width:12px;height:12px;border-radius:50%;background:#ef4444;display:inline-block;"></span>
                        <span
                            style="width:12px;height:12px;border-radius:50%;background:#f59e0b;display:inline-block;"></span>
                        <span
                            style="width:12px;height:12px;border-radius:50%;background:#10b981;display:inline-block;"></span>
                    </div>
                    <div
                        style="flex:1;background:#fff;border-radius:20px;padding:0.3rem 0.9rem;font-size:0.8rem;color:#64748b;display:flex;align-items:center;gap:6px;border:1px solid #cbd5e1;max-width:320px;margin:0 auto;">
                ...
                <svg viewBox="0 0 880 480" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g transform="translate(232,440)">
                        ...
                        <text x="0" y="20" fill="#64748b" font-family="sans-serif" font-size="10">Página 1 de 1 (3
                            elementos)</text>
                    </g>
                </svg>
            </div>
    ...
    <section style="background:var(--bg-light-alt); padding:5rem 0 6rem;">
        <div class="container animate-on-scroll fade-in-up">
            ...
            <h2
                style="text-align:center; font-size:clamp(1.75rem,3vw,2.5rem); font-weight:700; color:var(--text-dark); margin-bottom:0.75rem; letter-spacing:-0.02em;">
                Todo lo que necesita tu negocio</h2>
            <p
                style="text-align:center; color:var(--text-dark-muted); font-size:1.05rem; max-width:560px; margin:0 auto 3.5rem;">
                Sin hojas de cálculo, sin documentos de Word desorganizados, sin imágenes por WhatsApp.</p>
            <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:1.75rem;">
                ...
                foreach ($features as $f): ?>
                    <div style="background:#fff; border:1px solid var(--border-light); border-radius:var(--radius-lg); padding:2rem 1.75rem; transition:transform 0.25s, box-shadow 0.25s;"
                        onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 16px 40px rgba(18,58,44,0.1)';"
    ...
    <!-- CTA -->
    <section
        style="background:linear-gradient(135deg,var(--primary) 0%,#1a4d38 100%); padding:5rem 0; text-align:center;">
        <div class="container animate-on-scroll fade-in-up">
