    ...
    public function admin_scripts(): void {
        if ( $this->is_onboarding_admin_page() ) {
            ...
            $localize_data = array(
                ...
                'mcp_connector_banner'    => $this->helper->get_mcp_connector_banner_status(),
                ...
                'translations'            => array(
                    ...
                    'hostinger_easy_onboarding_mcp_connector_banner_title'                           => __( 'New: Hostinger Connector', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_mcp_connector_banner_description'                     => __( 'Connect Claude, Cursor, VS Code, or your favorite AI tool to your site with Hostinger Connector. Update content, manage media, and handle site tasks – just by asking.', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_mcp_connector_banner_setup'                           => __( 'Set up Connector', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_mcp_connector_banner_dismiss'                         => __( 'Dismiss', 'hostinger-easy-onboarding' ),
