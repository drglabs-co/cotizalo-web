...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
    ...
    <style>
        .lp-hero {
            ...
            padding-bottom: 5rem;
            background: linear-gradient(135deg, #1a3a5c 0%, #0f2a44 60%, var(--bg-surface) 100%);
            text-align: center;
        }
...
<body <?php body_class(); ?>>
    ...
    <section class="benefits-section">
        <div class="container animate-on-scroll fade-in-up">
            ...
            <p class="section-subtitle">Diseñado para profesionales independientes y pequeñas empresas de servicios en
                México.</p>
            <div class="benefits-grid">
                <div class="benefit-card">
                    ...
                    <p>Genera propuestas con tu logo, datos y precios. Descarga el PDF o comparte el enlace directamente
                        con tu cliente.</p>
                </div>
                <div class="benefit-card">
                    <div class="benefit-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <p>Guarda tus servicios con precios y descripción. Agrégalos a cualquier presupuesto en un clic, sin
                        repetir datos.</p>
                </div>
                <div class="benefit-card">
                    <div class="benefit-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <p>Sabe cuándo tu cliente abrió el presupuesto. Recibe notificaciones y actúa en el momento exacto
                ...
                <div class="benefit-card">
                    ...
                    <p>Comparte el presupuesto en segundos con un clic. Tu cliente lo recibe en su celular sin instalar
                        ninguna app.</p>
                </div>
                <div class="benefit-card">
                    <div class="benefit-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <p>Tu cliente aprueba el presupuesto con firma digital desde el mismo enlace. Queda registrada con
                        fecha y hora.</p>
                </div>
                <div class="benefit-card">
                    <div class="benefit-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <p>Accede a todos tus presupuestos enviados, con su estado (abierto, aceptado, vencido) desde un
                        panel central.</p>
                </div>
            </div>
        </div>
    ...
    <section class="compare-section">
        <div class="container animate-on-scroll fade-in-up">
            ...
            <p class="section-subtitle">Descubre por qué cientos de profesionales ya abandonaron las hojas de cálculo.
            </p>
            <div style="overflow-x:auto;">
                <table class="compare-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Genera PDF profesional con logo</td>
                            <td class="yes">✓ Automático</td>
                            <td class="no">✗ Manual y lento</td>
                        </tr>
                        <tr>
                            <td>Envío por WhatsApp en un clic</td>
                            <td class="yes">✓ Incluido</td>
                            <td class="no">✗ No disponible</td>
                        </tr>
                        <tr>
                            <td>Seguimiento de apertura</td>
                            <td class="yes">✓ Notificación automática</td>
                            <td class="no">✗ No disponible</td>
                        </tr>
                        <tr>
                            <td>Firma digital del cliente</td>
                            <td class="yes">✓ Incluida</td>
                            <td class="no">✗ No disponible</td>
                        </tr>
                        <tr>
                            <td>Catálogo de servicios reutilizable</td>
                            <td class="yes">✓ Con un clic</td>
                            <td class="no">✗ Copiar y pegar</td>
                        </tr>
                        <tr>
                            <td>Historial de clientes</td>
                            <td class="yes">✓ Centralizado</td>
                            <td class="no">✗ Archivos dispersos</td>
                        </tr>
                        <tr>
                            <td>Funciona en el celular</td>
                            <td class="yes">✓ Siempre</td>
                            <td class="no">✗ Limitado</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="container animate-on-scroll fade-in-up">
            ...
            <div class="faq-list" style="margin-top:2.5rem;">
                <details class="faq-item">
                    ...
                    <p>Aunque se usan indistintamente, una cotización es una propuesta de precio que puede cambiar,
                        mientras que un presupuesto suele ser un compromiso más formal de costos. Cotízalo te permite
                        crear ambos con la misma herramienta sin complicaciones.</p>
                </details>
                <details class="faq-item">
                    <summary>¿Puedo usar Cotízalo siendo freelancer o trabajador independiente?</summary>
                    <p>Sí, Cotízalo está diseñado especialmente para profesionales independientes, freelancers,
                        consultores y microempresas que necesitan presentar presupuestos de forma rápida y profesional
                        sin invertir en software costoso.</p>
                </details>
                <details class="faq-item">
                    <summary>¿Se puede usar en el celular para hacer presupuestos?</summary>
                    <p>Sí. Cotízalo funciona completamente desde el navegador de tu celular. Puedes crear, editar y
                        enviar presupuestos desde donde estés, sin instalar ninguna aplicación.</p>
                </details>
                <details class="faq-item">
                    <summary>¿Cotízalo reemplaza al Excel para hacer presupuestos?</summary>
                    <p>Sí. Cotízalo es la alternativa directa al Excel. Guarda tu catálogo de servicios, registra el
                        historial de presupuestos por cliente y genera PDFs profesionales sin fórmulas ni formatos
                        complicados.</p>
                </details>
                <details class="faq-item">
                    <summary>¿Puedo ver si mi cliente revisó el presupuesto?</summary>
                    <p>Sí. Cotízalo notifica cuando el cliente abre el enlace del presupuesto. Así sabes exactamente si
                        lo leyó y puedes hacer seguimiento en el momento adecuado para cerrar la venta.</p>
                </details>
            </div>
        </div>
    </section>
