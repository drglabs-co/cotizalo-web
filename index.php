...
<body <?php body_class(); ?>>
    ...
    <header>
        <div class="container nav-container">
            <a href="https://cotizalo.net/" class="logo">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/assets/logos/LOGOTIPO3/Cotizalo-8.png?v=2"
            ...
            <div class="nav-buttons">
                ...
                <a href="https://app.cotizalo.net/signup" class="btn btn-primary btn-nav"
                    style="margin-left: 10px;">Crear Cuenta Free</a>
            </div>
        </div>
    </header>
    ...
    <section class="hero">
        <div class="container relative">
            ...
            <div class="hero-image-wrapper animate-on-scroll delay-200">
                <div
                    style="background: rgba(15,23,42,0.8); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; height: 350px; display: flex; flex-direction: column; padding: 20px;">
                    <div
                        style="display: flex; gap: 10px; margin-bottom: 20px; align-items: center; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 15px;">
                        <div style="width: 12px; height: 12px; border-radius: 50%; background: #ef4444;"></div>
                        <div style="width: 12px; height: 12px; border-radius: 50%; background: #eab308;"></div>
                        <div style="width: 12px; height: 12px; border-radius: 50%; background: #22c55e;"></div>
                        <div
                            style="margin-left: 15px; color: rgba(255,255,255,0.4); font-size: 12px; font-family: monospace;">
                            app.cotizalo.net/dashboard</div>
                    </div>
                    <div style="display: flex; gap: 20px; height: 100%;">
                        ...
                        <div style="flex-grow: 1; display: flex; flex-direction: column; gap: 15px;">
                            <div
                                style="height: 40px; background: linear-gradient(90deg, rgba(99,102,241,0.1), transparent); border-radius: 8px;">
                            </div>
                            <div
                                style="flex-grow: 1; background: rgba(255,255,255,0.02); border-radius: 8px; border: 1px dashed rgba(255,255,255,0.1); display:flex; align-items: center; justify-content: center;">
    ...
    <section id="features" class="container">
        <div style="text-align: center; max-width: 600px; margin: 0 auto 3rem;" class="animate-on-scroll">
            ...
            <p>Diseñado para equipos agiles que requieren rapidez, elegancia y precisión en cada presupuesto que
                entregan.</p>
        </div>
        ...
        <div class="features-grid">
            ...
            <div class="feature-card animate-on-scroll delay-200">
                ...
                <p>Toda tu información de ventas viaja asegurada mediante encriptación moderna. Nunca pierdas un dato.
                </p>
            </div>
            ...
            <div class="feature-card animate-on-scroll delay-400">
                ...
                <p>Tus cotizaciones siempre en la nube. Accede, edita y comparte desde tu celular o computadora en
                    cualquier momento.</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="animate-on-scroll" style="text-align: center; max-width: 650px; margin: 0 auto 4rem;">
                ...
                ">
                    ...
                    <span
                        style="font-size: 0.75rem; font-weight: 600; color: #4ade80; letter-spacing: 0.08em; text-transform: uppercase;">En
                        la Nube · Siempre Disponible</span>
                </div>
                ...
                <p style="color: rgba(255,255,255,0.6); font-size: 1.05rem; line-height: 1.7;">
                    Tus cotizaciones viven en la nube. Ajústalas en tiempo real y tu cliente las aprueba al instante —
                    sin correos, sin esperas, sin complicaciones.
                </p>
            </div>
            ...
            " class="mobile-section-grid">
                ...
                <div class="animate-on-scroll delay-100">
                    ...
                    ">
                        ...
                        ">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#4ade80"
                        ...
                        <div>
                            <h3 style="font-size: 1.1rem; font-weight: 700; color: #fff; margin: 0 0 0.4rem;">
                                Cotizaciones en la nube</h3>
                            <p style="color: rgba(255,255,255,0.55); font-size: 0.95rem; line-height: 1.65; margin: 0;">
                                Todas tus propuestas se guardan automáticamente en la nube. Sin archivos locales, sin
                                riesgo de perder información. Disponibles 24/7 desde cualquier dispositivo.
                            </p>
                        </div>
                    </div>
                    ...
                    ">
                        <div style="
                            ...
                            display: flex; align-items: center; justify-content: center;
                        ">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#818cf8"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                            </svg>
                        </div>
                        <div>
                            <h3 style="font-size: 1.1rem; font-weight: 700; color: #fff; margin: 0 0 0.4rem;">Acceso
                                total desde el móvil</h3>
                            <p style="color: rgba(255,255,255,0.55); font-size: 0.95rem; line-height: 1.65; margin: 0;">
                                Crea, revisa y envía cotizaciones desde tu celular en segundos. Tu negocio no se detiene
                                aunque estés fuera de la oficina.
                            </p>
                        </div>
                    </div>
                    ...
                    ">
                        ...
                        <div>
                            <h3 style="font-size: 1.1rem; font-weight: 700; color: #fff; margin: 0 0 0.4rem;">Ajustes en
                                tiempo real · Aprobación inmediata</h3>
                            <p style="color: rgba(255,255,255,0.55); font-size: 0.95rem; line-height: 1.65; margin: 0;">
                                ¿El cliente pide un cambio de último momento? Actualiza la cotización al instante y él
                                la ve reflejada de inmediato. Aprobación con un clic, sin ir y venir de correos.
                            </p>
                        </div>
                    </div>
                    ...
                    ">
                        ...
                        <div>
                            <h3 style="font-size: 1.1rem; font-weight: 700; color: #fff; margin: 0 0 0.4rem;">Búsqueda y
                                seguimiento sin límites de IA</h3>
                            <p style="color: rgba(255,255,255,0.55); font-size: 0.95rem; line-height: 1.65; margin: 0;">
                                Olvídate de buscar imágenes perdidas en WhatsApp o quedarte sin créditos en bots de IA.
                                Accede a una interfaz gráfica para encontrar cualquier propuesta en un clic, editar
                                cambios y dar seguimiento a cada cliente desde cualquier dispositivo.
                            </p>
                        </div>
                    </div>
                            ...
                            ">
                                ...
                                ">
                                    ...
                                    <div
                                        ...
                                        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#4ade80"
                                            stroke-width="2.5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                ">
                                    <div style="font-size: 9px; color: rgba(255,255,255,0.4); margin-bottom: 4px;">
                                        COTIZACIÓN #0047</div>
                                    <div style="font-size: 11px; font-weight: 600; color: #fff; margin-bottom: 8px;">
                                        Servicio de Instalación</div>
                                    <div style="display: flex; justify-content: space-between; align-items: center;">
                                        <div style="font-size: 14px; font-weight: 700; color: #4ade80;">$12,500 MXN
                                        </div>
                                        <div style="
                                ...
                                ">
                                    ...
                                    "></div>
                                    <span
                                        style="font-size: 9px; color: rgba(255,255,255,0.7); line-height: 1.4;">Cliente
                                        viendo cambios<br><strong style="color: #818cf8;">en tiempo
                                            real...</strong></span>
                                </div>
                                ...
                                <div style="
                                    ...
                                    margin-top: 14px;
                                ">
                                    <div style="width: 20px; height: 3px; background: #4ade80; border-radius: 3px;">
                                    </div>
                                    <div
                                        style="width: 6px; height: 3px; background: rgba(255,255,255,0.15); border-radius: 3px;">
                                    </div>
                                    <div
                                        style="width: 6px; height: 3px; background: rgba(255,255,255,0.15); border-radius: 3px;">
                                    </div>
    ...
    <section class="cta-section">
        <div class="container animate-on-scroll">
            <div class="cta-box">
                ...
                <p style="max-width: 600px; margin: 0 auto 2rem; color: #fff; opacity: 0.8;">Únete a cientos de empresas
                    que ya automatizan sus procesos de cotización y ahorran horas semanales administrando envíos.</p>
                <a href="https://app.cotizalo.net/signup" class="btn btn-primary"
                    style="background: white; color: #0A0E1A; box-shadow: none;">Crear cuenta Gratis</a>
            </div>
        </div>
    </section>
